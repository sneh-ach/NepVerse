  ...
  return (
    <div className="min-h-screen py-8 sm:py-12">
      <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4">About NepVerse</h1>
        ...
        <div className="space-y-8 sm:space-y-12">
          ...
          {/* Story */}
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Our Story</h2>
          ...
          {/* Values */}
          <section>
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-4 sm:mb-6">Our Values</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-card p-4 sm:p-6 rounded-lg">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Community First</h3>
                <p className="text-sm sm:text-base text-gray-400">
                  We prioritize our community of viewers and creators, building a platform that serves their needs.
                </p>
              </div>
              <div className="bg-card p-4 sm:p-6 rounded-lg">
                <Award className="w-6 h-6 sm:w-8 sm:h-8 text-primary mb-3 sm:mb-4" />
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">Quality Content</h3>
                <p className="text-sm sm:text-base text-gray-400">
                  We curate and produce only the highest quality Nepali content for our audience.
                </p>
              </div>
              <div className="bg-card p-4 sm:p-6 rounded-lg sm:col-span-2 md:col-span-1">
                <Globe className="w-6 h-6 sm:w-8 sm:h-8 text-primary mb-3 sm:mb-4" />
          ...
          {/* CTA */}
          <section className="bg-card p-6 sm:p-8 rounded-lg text-center">
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Join the NepVerse Community</h2>
